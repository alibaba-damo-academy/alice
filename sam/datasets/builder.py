...
def _concat_dataset(cfg, default_args=None):
    from  thirdparty.mmdetection.mmdet.datasets.dataset_wrappers import ConcatDataset
...
def build_dataset(cfg, default_args=None):
    from  thirdparty.mmdetection.mmdet.datasets.dataset_wrappers import (ConcatDataset, RepeatDataset,
